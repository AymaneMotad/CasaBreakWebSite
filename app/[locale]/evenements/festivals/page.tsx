...
import { PartyPopper, ChevronDown, ChevronUp, ChevronRight, Calendar, MapPin } from "lucide-react"
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pb-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Festivals</h1>
          <p className="text-xl text-gray-600 max-w-2xl">
            Découvrez les festivals à Casablanca
          </p>
        </div>
      </div>
                  ...
                  <div className="relative h-64 overflow-hidden bg-gray-100">
                    {event.main_image ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center">
                        <PartyPopper className="w-16 h-16 text-gray-400" />
                      </div>
                    )}
                    <div className="image-fallback hidden w-full h-full bg-gradient-to-br from-green-100 to-emerald-100 items-center justify-center absolute inset-0 z-10">
                      <PartyPopper className="w-16 h-16 text-gray-400" />
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-3 mt-auto">
                      {description && showExpandButton && (
                        <button
                          ...
                          className="inline-flex items-center text-green-600 hover:text-green-700 font-medium text-sm transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded px-2 py-1 -ml-2"
                        >
                          {isExpanded ? (
                            <>
                              Lire moins
                      ...
                      <Link
                        href={`/${locale}/evenements/festivals/${event.slug}`}
                        className="inline-flex items-center text-green-600 hover:text-green-700 font-medium text-sm transition-colors ml-auto"
                      >
                        Voir les détails
