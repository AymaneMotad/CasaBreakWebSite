...
export default function ConcertsSpectaclesPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pb-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Concerts & Spectacles</h1>
          <p className="text-xl text-gray-600 max-w-2xl">
            Découvrez les meilleurs concerts et spectacles à Casablanca
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">
              {searchTerm ? `Aucun événement trouvé pour "${searchTerm}".` : 'Aucun événement trouvé.'}
            </p>
          </div>
        ) : (
          <>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-64 overflow-hidden bg-gray-100">
                    ...
                    <div className="image-fallback hidden w-full h-full bg-gradient-to-br from-purple-100 to-pink-100 items-center justify-center absolute inset-0 z-10">
                      <Music className="w-16 h-16 text-gray-400" />
                    </div>
                  </div>
